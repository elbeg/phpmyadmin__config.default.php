...
$cfg['Export']['file_template_table'] = '@TABLE@'.'__'.date("Y-md-Hi");
...
$cfg['Export']['file_template_database'] = '@DATABASE@'.'__'.date("Y-md-Hi");
...
$cfg['Export']['file_template_server'] = '@SERVER@'.'__'.date("Y-md-Hi");
